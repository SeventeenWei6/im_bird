...
import com.zw.bo.UserBO;
import com.zw.enums.OperatorFriendRequestTypeEnum;
import com.zw.enums.SearchFriendsStatusEnum;
import com.zw.pojo.ChatMsg;
...
public class UserController {
    ...
    public IWdzlJSONResult  registerOrlogin(@RequestBody UserBO userBO) throws Exception {
        ...
        String userFacePath = "F:\\"+userBO.getUserId()+"userFaceBase64.png";
        //调用FileUtils 类中的方法将base64字符串转为文件对象
        ...
        System.out.println(arr[0]+thump+arr[1]);
        //更新用户头像
        User user = new User();
